...
//            }
                            ...
                            VStack{
                                NavigationLink {
                                    ...
                                    self.views[i]
                                        ...
                                        .animation(.interpolatingSpring(stiffness: itemWidth, damping: 30.0, initialVelocity: 10.0), value: dragState.translation)
                                }
    ...
    func getOffset(_ i:Int) -> CGFloat{
        ...
        {
            //Set offset +1
            return self.dragState.translation.width + (itemWidth + 16)
        }
        else if
            (i) == relativeLoc() - 1
                ||
        ...
        {
            return self.dragState.translation.width + (2*(itemWidth + 16))
        }
        else if
            (i) == relativeLoc() - 2
                ||
        ...
        {
            return self.dragState.translation.width + (3*(itemWidth + 16))
        }
        else if
            (i) == relativeLoc() - 3
                ||
